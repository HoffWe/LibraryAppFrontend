...
export const Library = () => {
  return (
    <LibraryContainer>
      ...
      <StyleHeading>
        <h1>
          <span>Zapraszamy do Nowoczesnej Biblioteki</span>
        </h1>
      </StyleHeading>
      <StyleBody>
        ...
        <h2>
          „Książka to mędrzec łagodny i pełen słodyczy, <br />
          który puste życie napełnia światłem, <br />a puste serca wzruszeniem.”
        </h2>
        <h3>
          <br />
          Kornel Makuszyński
